@extends('layouts.login', ['title' => 'Freezolar Refrigeração - Administração - Login'])
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="form-group row justify-content-center pb-2">
                                    <div class="col-12 col-md-12 col-lg-12">
                                        <input id="login" type="text" class="form-control" name="cliente" value="{{ old('cliente') }}" autofocus placeholder="Nome do Cliente">
                                    </div>
                                </div>
