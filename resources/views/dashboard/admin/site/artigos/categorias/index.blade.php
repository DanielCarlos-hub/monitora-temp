@extends('layouts.dashboard.admin', ['title' => 'Freezolar Refrigeração - Administração - Posts - Lista de Categorias'])

@section('content')
<div class="bg-body-light">
    <div class="content content-full p-1">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill h3 my-2 pl-3">Categorias</h1>
...
<div class="content p-0">
    <div class="block">
        <div class="block-content block-content-full">
            <div class="row pb-3">
                <div class="col-md-3">
                    <a class="btn btn-info btn-sm" role="button" href="{{ route("dashboard.admin.site.categorias.create") }}"><i class="fa fa-plus"> </i> Adicionar</a>
                </div>
            </div>
...
@section('javascript')
    ...
    <script>
        ...
        config = {
            route: {
                index: '{{ route("dashboard.admin.site.categorias.index") }}',
                show: '{{ route("dashboard.admin.site.categorias.show", ":id") }}',
                edit: '{{ route("dashboard.admin.site.categorias.edit", ":id") }}',
            },
            assets: {
