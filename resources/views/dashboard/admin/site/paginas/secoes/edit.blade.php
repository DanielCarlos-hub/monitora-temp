...
<div class="bg-body-light">
    <div class="content content-full p-1">
        <div class="">
            <h1 class="flex-sm-fill h3 my-2 pl-3">Editando Seção de {{$section->section_name}} da Página {{$page->page_name}}</h1>
            <nav class="flex-sm-00-auto ml-sm-3 pr-3" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    ...
                    <li class="breadcrumb-item">Editar Seção</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="block-content block-content-full">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <form class="mb-5" method="POST" action="{{ route('dashboard.admin.site.pages.sections.update', ['page' => $page->id, 'section' => $section->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="section_name">Nome da Seção: <small style="color:red;"> * </small></label>
                                    <input type="text" class="form-control" placeholder="Nome da Seção..." value="{{$section->section_name}}" disabled>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="section_title">Título da Seção: <small style="color:red;"> * </small></label>
                                    <input type="text" class="form-control" id="section_title" name="section_title" placeholder="Título da Seção..." required value="{{$section->section_title}}">
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="section_description">Descrição da Seção</label>
                                    <textarea class="ckeditor" name="section_description">{!! $section->section_description !!}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
