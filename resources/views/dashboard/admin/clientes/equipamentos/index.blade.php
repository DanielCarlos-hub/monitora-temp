@extends('layouts.dashboard.admin', ["title" => "Freezolar Refrigeração - Administração - Equipamentos"])
...
<div class="content p-0">
    <div class="block">
        <div class="block-content block-content-full">
            <div class="row pb-3">
                <div class="col-md-3">
                    <a class="btn btn-success btn-sm" href="{{ route('dashboard.admin.clientes.equipamentos.create', $tenant->id) }}">
...
@section('javascript')
    ...
    <script>
        ...
        config = {
            route: {
                index: '{{ route("dashboard.admin.clientes.equipamentos.index", $tenant->id) }}',
                edit: '{{ route("dashboard.admin.clientes.equipamentos.edit", ["equipamento" => ":id", "cliente" => $tenant->id]) }}',
                show: '{{ route("dashboard.admin.clientes.equipamentos.show", ["equipamento" => ":id", "cliente" => $tenant->id]) }}',
            },
            assets: {
