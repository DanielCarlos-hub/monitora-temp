@extends('layouts.dashboard.admin', ["title" => "Freezolar Refrigeração - Administração - Notificações"])
...
<div class="content">
    ...
    <div class="row text-center">
        <div class="col-12 col-md-12 mb-1">
            <a class="btn btn-sm btn-warning" href="{{ route('dashboard.admin.clientes.show', $tenant->id) }}">Voltar</a>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
...
<div class="modal" id="addEquipamento" tabindex="-1" role="dialog" aria-labelledby="addEquipamento" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content ">
            <form class="form-horizontal" id="formCliente" method="post" action="{{route('dashboard.admin.clientes.equipamentos.store', $tenant->id) }}" autocomplete="off">
                @csrf
