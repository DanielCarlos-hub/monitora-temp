            ...
            <table id="logs" class="table table-striped table-bordered data-table responsive" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('dashboard.admin.clientes.equipamentos.logs.show', ['cliente' => $tenant->id, 'equipamento' => $equipamento->id, 'log' => $logs->id]) }}" title="Visualizar" role="button" class="btn btn-sm mr-1"><i class="fa fa-eye"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
