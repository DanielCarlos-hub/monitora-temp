...
<div class="content p-0">
    <div class="block">
        <div class="block-content block-content-full">
            <div class="row pb-3">
                <div class="col-md-3">
                    <a class="btn btn-info btn-sm" role="button" href="{{ route("dashboard.monitoramento.clientes.create") }}"> <i class="fas fa-plus"></i> Adicionar</a>
                </div>
            </div>
...
@section('javascript')
    ...
    <script>
        ...
        config = {
            route: {
                index: '{{ route("dashboard.monitoramento.clientes.index") }}',
                edit: '{{ route("dashboard.monitoramento.clientes.edit", ":id") }}',
                show: '{{ route("dashboard.monitoramento.clientes.show", ":id") }}',
            },
            assets: {
