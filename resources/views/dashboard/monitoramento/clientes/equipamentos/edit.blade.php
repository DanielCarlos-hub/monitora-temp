@extends('layouts.dashboard.monitoramento', ["title" => "Freezolar Refrigeração - Monitoramento - Editar Equipamento"])
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3 pr-3" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    ...
                    <li class="breadcrumb-item" aria-current="page">
                        <a class="link-fx" href="{{ route('dashboard.monitoramento.clientes.equipamentos.show', ['equipamento' => $equipamento->id, 'cliente' => $tenant->id]) }}">{{$equipamento->nome_equipamento}} ({{$equipamento->num_placa}})</a>
                    </li>
...
<div class="content p-0">
    <div class="block">
        <div class="block-content block-content-full">
            <div class="row pb-3">
                <div class="col-12">
                    <form class="form-horizontal" method="post" autocomplete="off" action="{{ route('dashboard.monitoramento.clientes.equipamentos.update', ['equipamento' => $equipamento->id, 'cliente' => $tenant->id]) }}">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="col-md-12 col-lg-10">
                                <div class="form-group row mb-0">
                                    <div class="col-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="col-12 p-0">
                                            <input type="text" class="form-control" name="nome_equipamento" id="nome_equipamento" value="{{$equipamento->nome_equipamento}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-12 p-0">
                                            <select class="form-control" name="tipo_id" id="tipo_id" style="width: 100%;" required>
                                                ...
                                                @foreach($tipos as $tipo)
                                                    <option value="{{$tipo->id}}" {{$equipamento->tipo_id == $tipo->id ? 'selected' : ''}}>{{$tipo->tipo}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="col-sm-12 p-0">
                                            <input type="text" class="form-control" name="num_placa" id="num_placa" value="{{$equipamento->num_placa}}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-12 col-md-6 col-lg-3">
                                        ...
                                        <div class="col-sm-12 p-0">
                                            <input type="number" class="form-control" step="0.50" name="temperatura_min" id="temperatura_min" value="{{$equipamento->temperatura_min}}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <label for="temperatura_max" class="control-label col-form-label" style="padding-left: 15px;">Temp Máxima</label>
                                        <div class="col-sm-12 p-0">
                                            <input type="number" class="form-control" step="0.50" name="temperatura_max" id="temperatura_max" value="{{$equipamento->temperatura_max}}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <label for="temperatura_crit_min" class="control-label col-form-label" style="padding-left: 15px;">Temp Crítica MIN</label>
                                        <div class="col-sm-12 p-0">
                                            <input type="number" class="form-control" step="0.50" name="temperatura_crit_min" id="temperatura_crit_min" value="{{$equipamento->temperatura_crit_min}}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <label for="temperatura_crit_max" class="control-label col-form-label" style="padding-left: 15px;">Temp Crítica MAX</label>
                                        <div class="col-sm-12 p-0">
                                            <input type="number" class="form-control" step="0.50" name="temperatura_crit_max" id="temperatura_crit_max" value="{{$equipamento->temperatura_crit_max}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
