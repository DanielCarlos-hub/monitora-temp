...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link rel="icon" type="image/png" sizes="16x16" href="/storage/clientes/{{ ClienteConfig::favicon() }}">
...
{{--         <link rel="shortcut icon" href="/storage/site/favicon/favicon-16x16.png">
    ...
    <body>
        <div id="page-container" class="sidebar-o enable-page-overlay sidebar-dark side-scroll page-header-fixed">
            ...
            @component('components.dashboard.cliente.sidebar')@endcomponent
            @component('components.dashboard.cliente.header')@endcomponent
