...
class ClienteEquipamentosController extends Controller
{
    ...
    public function index(Request $request, $cliente)
    {
        ...
        return view('dashboard.admin.clientes.equipamentos.index', compact('tenant'));
    }
    ...
    public function create($cliente){
        ...
        return view('dashboard.admin.clientes.equipamentos.create', compact('tenant', 'tipos'));
    ...
    public function store(Request $request, $cliente)
    {
        ...
        try {
            ...
            return redirect()->route('dashboard.admin.clientes.show', $cliente)->with($notification);
    ...
    public function show($cliente, $id)
    {
        try {
            ...
            return view('dashboard.admin.clientes.equipamentos.temperaturas', compact('tenant', 'equipamento', 'tipos'));
    ...
    public function edit($cliente, $id)
    {
        try {
            ...
            return view('dashboard.admin.clientes.equipamentos.edit', compact('tenant', 'equipamento', 'tipos'));
    ...
    public function notifications($cliente, $equipamento){
        ...
        try {
            ...
            return view('dashboard.admin.clientes.equipamentos.notifications', compact('tenant', 'equipamento'));
    ...
    public function logs($cliente, $equipamento){
        ...
        try {
            ...
            return view('dashboard.admin.clientes.equipamentos.logs', compact('tenant', 'equipamento'));
    ...
    public function visualizarLog($cliente, $equipamento, $log){
        ...
        try {
            ...
            return view('dashboard.admin.clientes.equipamentos.visualizarLog', compact('tenant', 'equipamento', 'log'));
