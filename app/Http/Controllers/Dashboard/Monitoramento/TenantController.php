...
class TenantController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard.monitoramento.clientes.index');
    }

    public function create()
    {
        return view('dashboard.monitoramento.clientes.create');
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            if($db['status']){
                ...
                return redirect()->route('dashboard.monitoramento.clientes.index')->with($notification);
    ...
    public function show($id)
    {
        try {
            ...
            return view('dashboard.monitoramento.clientes.clienteEquipamentos', compact('tenant', 'equipamentos', 'countEquipamentos', 'tipos'));
    ...
    public function edit($id)
    {
        try {
            ...
            return view('dashboard.monitoramento.clientes.edit', compact('tenant'));
